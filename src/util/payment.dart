...
class Airtime {
  ...
  static Future<void> determineOperator(
    ...
    http
      ...
      print(air);
      event.reply(
          "Are you sure you want to send *\$${details["amount"]}* Worth of  *${air["name"].split(" ")[0]} Top Up*  to *${event.text}*?\n\nFX rate: *${await main.firebasedb.get("${main.DB_PATH}/FX-rate.json")} / \$1.00*",
      ...
      main.patch(main.awaitingWithdrawalDB, event.from.id, {"type": air["id"]});
    });
  }
}
